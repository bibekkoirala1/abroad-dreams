    ...
    return (
        <div className={"container"}>
            ...
            <div className="header-wrapper">
                <div className="header">
                    ...
                    <div className="login-register">
                        ...
                        <input type="email" alt="Email" placeholder="Your Registered Email Address" />
                        <input
            ...
            <div className="footer">
                <p>Coders Brigade: Batch 33c. <strong> &copy; 2023 Abroad Dreams. </strong> All Rights Reserved</p>
            </div>
